...
This package for pulling per-day data on COVID-19 cases in France, averaged from the [opencovid19-fr](https://github.com/opencovid19-fr/data) data, available on GitHub. (README in English available [here](https://github.com/opencovid19-fr/data/blob/master/README.en.md).)
